                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-4 input-column">
                        <div class="dropdown"><button class="btn btn-light dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"> Selectionne ton statut</button>
                            <div class="dropdown-menu"><a class="dropdown-item" href="registespace.php">Espace Personnel</a><a class="dropdown-item" href="registeparain.php">parain</a><a class="dropdown-item" href="registepartenaire.php">Partenaire</a></div>
                        </div>
                    </div>
                </div>
